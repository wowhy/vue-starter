  ...
  <aside class="left-sidebar-nav">
    <ul class="slide-out side-nav fixed leftside-navigation">
        ...
        <div class="row">
          ...
          <div class="col col s8 m8 l8">
            ...
            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#"
               data-activates="profile-dropdown">John Doe<i class="material-icons right">arrow_drop_down</i></a>
      ...
      <li class="no-padding">
        <ul class="collapsible collapsible-accordion">
          <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i
            class="material-icons">view_carousel</i> Layouts</a>
      ...
      <li class="no-padding">
        <ul class="collapsible collapsible-accordion">
          <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i
            class="material-icons">invert_colors</i> CSS</a>
            <div class="collapsible-body">
              <ul>
          ...
          <li class="bold"><a class="collapsible-header  waves-effect waves-cyan"><i class="material-icons">palette</i>
            UI Elements</a>
            <div class="collapsible-body">
              <ul>
      ...
      <li><a href="angular-ui.html"><i class="material-icons">verified_user</i> Angular UI <span
